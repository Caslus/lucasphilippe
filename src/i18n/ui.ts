...
export const ui: UIStrings = {
	en: {
		...
		description: "I’m a software engineer who loves building full-stack applications. I enjoy tinkering with servers and exploring new technologies in my free time.",
	...
	jp: {
		...
		greeting: "こんにちは！僕は",
		description: "フルスタック アプリケーションの構築が好きなソフトウェア エンジニアです。空き時間にはサーバーをいじったり、新しいテクノロジーを探究したりするのが好きです。",
		location: "クリチバ、ブラジル",
